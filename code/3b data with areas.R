...
saveRDS(jd_random, file=paste0('out/zmb_with_areas/random/jd.rds'))
saveRDS(jd_weighted, file=paste0('out/zmb_with_areas/weighted/jd.rds'))
saveRDS(jd_weighted_naive, file=paste0('out/zmb_with_areas/weighted_naive/jd.rds'))
saveRDS(jd_all, file=paste0('out/zmb_with_areas/combined/jd.rds'))