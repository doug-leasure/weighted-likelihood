...
saveRDS(jd_random, file=paste0('out/zmb/random/jd.rds'))
saveRDS(jd_weighted, file=paste0('out/zmb/weighted/jd.rds'))
saveRDS(jd_weighted_naive, file=paste0('out/zmb/weighted_naive/jd.rds'))
saveRDS(jd_all, file=paste0('out/zmb/combined/jd.rds'))