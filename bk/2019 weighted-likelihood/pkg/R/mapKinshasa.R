#' Create a map of Kinshasa study area
#'
#' @param file Output file to save map
#'
#' @return Map is saved to disk
#'
#' @export

mapKinshasa <- function(file){
  ...
  # saving
  tmap_save(sampling_kinshasa, width=3.4, height=4.3, units="in", filename = file)
}
