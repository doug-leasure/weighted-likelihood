#' Creates a barplot with population totals
#'
#' @param dat Plot data (see ?plotTotalsData)
#' @param file File name of jpeg image to save plot
#' @param pos.legend Position of legend
#' @param plotReal Logical to include plot legend
#' @param main Plot title
#'
#' @return Saves plot to disk as jpeg
#'
#' @export
